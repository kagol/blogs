...
![](/assets/html2canvas-principle-1.png)
...
![](/assets/html2canvas-principle-2.png)
...
![](/assets/html2canvas-principle-7.png)

#### 方法四：
方法四一般也要靠经验，我们扫一眼目录结构，其实很容易就能发现主入口src/index.ts

![](/assets/html2canvas-principle-8.png)
...
![](/assets/html2canvas-principle-9.png)
...
![](/assets/html2canvas-principle-10.png)
