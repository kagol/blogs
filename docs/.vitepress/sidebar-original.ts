  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { text: '系列1：实现 Tree 组件基本结构和文档', link: '/tech/2021/0-to-1-build-vue-component-library-1' },
        { text: '系列2：实现多层节点的 Tree 组件', link: '/tech/2021/0-to-1-build-vue-component-library-2' },
        { text: '系列3：给 Tree 组件增加展开/收起功能', link: '/tech/2021/0-to-1-build-vue-component-library-3' },
        { text: '系列4：搭建 Vite+Vue3+TS+JSX 工程', link: '/tech/2021/0-to-1-build-vue-component-library-4' },
        { text: '系列5：添加 VitePress 文档', link: '/tech/2021/0-to-1-build-vue-component-library-5' },
        { text: '系列6：开发一个组件库脚手架', link: '/tech/2021/0-to-1-build-vue-component-library-6' },
        { text: '系列7：增加组件单元测试', link: '/tech/2021/0-to-1-build-vue-component-library-7' },
        { text: '系列8：从0到1搭建 Vue3 组件库小结', link: '/tech/2021/0-to-1-build-vue-component-library-8' },
        { text: '系列9：Vue3 组件库 Monorepo 改造', link: '/tech/2021/0-to-1-build-vue-component-library-9' },
        { text: '系列10：如何实现组件的按需打包', link: '/tech/2021/0-to-1-build-vue-component-library-10' },
        { text: '系列11：实现 Tree 组件点选高亮功能', link: '/tech/2021/0-to-1-build-vue-component-library-11' },
        { text: '系列12：实现 Tree 组件节点勾选功能', link: '/tech/2021/0-to-1-build-vue-component-library-12' },
      ]
    },
    {
      text: '富文本编辑器',
